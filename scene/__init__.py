...
class Scene:
    ...
    def __init__(self, args: ModelParams, gaussians: GaussianModel, load_iteration=None, shuffle=True,
        ...
        if os.path.exists(os.path.join(args.source_path, "data_COLMAP/000000/sparse")):
            print("Found PKU-DyMvHumans COLMAP data, assuming PKU-DyMvHumans data set!")
            scene_info = sceneLoadTypeCallbacks["PKUDyMvHumans"](args)
